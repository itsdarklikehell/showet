...
class Platform_Android_Android(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[Android Android] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Android Android] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Android Android] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Android Android] State load: Delegated to RetroArch")
        return True
