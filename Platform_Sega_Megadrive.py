...
class Platform_Sega_Megadrive(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[Sega Megadrive] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Sega Megadrive] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Sega Megadrive] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Sega Megadrive] State load: Delegated to RetroArch")
        return True
