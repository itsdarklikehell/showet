...
class Platform_Atari_Lynx(PlatformBase):
    """Platform runner for Atari Lynx demos."""
    ...
    def load_game(self, rom_path: str) -> bool:
        ...
        print(f"[Atari Lynx] Loaded: {rom_path}")
        return True
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Atari Lynx] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Atari Lynx] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Atari Lynx] State load: Delegated to RetroArch")
        return True
