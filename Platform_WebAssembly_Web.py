...
class Platform_WebAssembly_Web(PlatformBase):
    ...
    def supported_platforms(self) -> list[str]:
        ...
        return ["webassembly_web"]

    def initialize(self) -> bool:
        print("[WebAssembly Web] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[WebAssembly Web] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[WebAssembly Web] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[WebAssembly Web] State load: Delegated to RetroArch")
        return True
