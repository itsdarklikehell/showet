    ...
    def find_ext_files(self):
        ...
        for file in self.prod_files:
            ...
            if size > 0:
                ...
                extensions = ['zip', 'rom', 'ri', 'mx1', 'mx2', 'col', 'dsk', 'cas', 'sg', 'sc', 'm3u']
                if file.endswith('.zip') or file.endswith('.rom') or file.endswith('.ri') or file.endswith('.mx1') or file.endswith('.mx2') or file.endswith('.col') or file.endswith('.dsk') or file.endswith('.sc') or file.endswith('.sg') or file.endswith('.sc') or file.endswith('.m3u'):
