...
class Platform_Microsoft_Xbox(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[Microsoft Xbox] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Microsoft Xbox] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Microsoft Xbox] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Microsoft Xbox] State load: Delegated to RetroArch")
        return True
