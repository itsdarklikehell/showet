...
class Platform_Microsoft_Msdos(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[Microsoft Msdos] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Microsoft Msdos] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Microsoft Msdos] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Microsoft Msdos] State load: Delegated to RetroArch")
        return True
