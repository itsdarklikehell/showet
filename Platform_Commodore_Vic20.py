...
class Platform_Commodore_Vic20(PlatformBase):
    ...
    def supported_platforms(self) -> list[str]:
        ...
        return ["commodore_vic20"]

    def initialize(self) -> bool:
        print("[Commodore Vic20] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Commodore Vic20] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Commodore Vic20] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Commodore Vic20] State load: Delegated to RetroArch")
        return True
