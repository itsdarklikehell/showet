...
class Platform_Snk_NeogeoPocket(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[Snk NeogeoPocket] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Snk NeogeoPocket] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Snk NeogeoPocket] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Snk NeogeoPocket] State load: Delegated to RetroArch")
        return True
