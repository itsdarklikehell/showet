"""Runner for the pouet "commodorecbm" platform.
...
class Platform_Commodore_CBMII(PlatformCommon):
    """Platform runner for Commodorecbm demos."""
    ...
    def supported_platforms(self) -> list[str]:
        """Return commodorecbm platform slug."""
        return ["commodorecbm"]
    ...
    def run(self) -> None:
        ...
        if DEBUGGING:
            print(f"Launching commodorecbm demo via RetroArch: {files[0]}")
