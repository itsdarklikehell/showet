...
## Overview
Java Java platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/java_java.json`
...
| .jar | Supported format | Native emulator |
| .sqc | Supported format | Native emulator |
| .jam | Supported format | Native emulator |
| .jad | Supported format | Native emulator |
| .kjx | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform java_java
```
