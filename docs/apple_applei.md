#  Apple AppleI Platform Documentation

## Overview
 Apple AppleI platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/apple_applei.json`
...
# Run in museum mode
showet-museum --platform apple_applei
```
