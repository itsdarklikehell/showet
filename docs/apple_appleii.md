#  Apple AppleII Platform Documentation

## Overview
 Apple AppleII platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/apple_appleii.json`
...
# Run in museum mode
showet-museum --platform apple_appleii
```
