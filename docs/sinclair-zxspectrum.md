# Sinclair Zxspectrum Platform Documentation

## Overview
Sinclair Zxspectrum platform for running retro demos with authentic presentation.
...
# Run in museum mode
showet-museum --platform sinclair_zxspectrum
```
