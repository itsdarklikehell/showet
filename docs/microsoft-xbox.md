# Microsoft Xbox Platform Documentation

## Overview
Microsoft Xbox platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/microsoft_xbox.json`
...
# Run in museum mode
showet-museum --platform microsoft_xbox
```
