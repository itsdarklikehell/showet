#  Commodore Pet Platform Documentation

## Overview
 Commodore Pet platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/commodore_pet.json`
...
# Run in museum mode
showet-museum --platform commodore_pet
```
