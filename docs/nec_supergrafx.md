#  Nec Supergrafx Platform Documentation

## Overview
 Nec Supergrafx platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nec_supergrafx.json`
...
# Run in museum mode
showet-museum --platform nec_supergrafx
```
