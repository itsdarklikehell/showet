#  Nintendo Pokemini Platform Documentation

## Overview
 Nintendo Pokemini platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nintendo_pokemini.json`
...
| .min | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform nintendo_pokemini
```
