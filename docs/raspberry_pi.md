#  Raspberry Pi Platform Documentation

## Overview
 Raspberry Pi platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/raspberry_pi.json`
...
# Run local file
showet-executor /path/to/demo.img

# Run in museum mode
showet-museum --platform raspberry_pi
```
