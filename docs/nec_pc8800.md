#  Nec Pc8800 Platform Documentation

## Overview
 Nec Pc8800 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nec_pc8800.json`
...
| .u88 | Supported format | Native emulator |
...
# Run local file
showet-executor /path/to/demo.d88

# Run in museum mode
showet-museum --platform nec_pc8800
```
