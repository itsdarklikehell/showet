#  Fairchild Channelf Platform Documentation

## Overview
 Fairchild Channelf platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/fairchild_channelf.json`
...
| .chf | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform fairchild_channelf
```
