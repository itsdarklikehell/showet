#  Commodore Vic20 Platform Documentation

## Overview
 Commodore Vic20 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/commodore_vic20.json`
...
# Run in museum mode
showet-museum --platform commodore_vic20
```
