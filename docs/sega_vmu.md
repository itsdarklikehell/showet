#  Sega Vmu Platform Documentation

## Overview
 Sega Vmu platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/sega_vmu.json`
...
| .vms | Supported format | Native emulator |
| .dci | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform sega_vmu
```
