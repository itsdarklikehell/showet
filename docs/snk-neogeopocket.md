# Snk Neogeopocket Platform Documentation

## Overview
Snk Neogeopocket platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/snk_neogeopocket.json`
...
# Run in museum mode
showet-museum --platform snk_neogeopocket
```
