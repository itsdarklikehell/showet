#  Nintendo FamicomDisksystem Platform Documentation

## Overview
 Nintendo FamicomDisksystem platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nintendo_famicomdisksystem.json`
...
# Run in museum mode
showet-museum --platform nintendo_famicomdisksystem
```
