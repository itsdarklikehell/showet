# Linux Linux Platform Documentation

## Overview
Linux Linux platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/linux_linux.json`
...
# Run in museum mode
showet-museum --platform linux_linux
```
