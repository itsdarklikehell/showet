# Commodore Plus4 Platform Documentation

## Overview
Commodore Plus4 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/commodore_plus4.json`
...
# Run in museum mode
showet-museum --platform commodore_plus4
```
