# Sega Stv Platform Documentation

## Overview
Sega Stv platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/sega_stv.json`
...
| .mds | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform sega_stv
```
