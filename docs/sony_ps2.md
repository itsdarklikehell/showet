#  Sony Ps2 Platform Documentation

## Overview
 Sony Ps2 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/sony_ps2.json`
...
# Run in museum mode
showet-museum --platform sony_ps2
```
