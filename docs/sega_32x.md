#  Sega 32X Platform Documentation

## Overview
 Sega 32X platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/sega_32x.json`
...
| .gg | Supported format | Native emulator |
| .smd | Supported format | Native emulator |
| .pco | Supported format | Native emulator |
| .md | Supported format | Native emulator |
| .32x | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform sega_32x
```
