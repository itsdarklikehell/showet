#  Wild VideoMPV Platform Documentation

## Overview
 Wild VideoMPV platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/wild_videompv.json`
...
# Run in museum mode
showet-museum --platform wild_videompv
```
