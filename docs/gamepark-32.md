# Gamepark 32 Platform Documentation

## Overview
Gamepark 32 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/gamepark_32.json`
...
# Run in museum mode
showet-museum --platform gamepark_32
```
