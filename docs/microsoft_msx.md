#  Microsoft Msx Platform Documentation

## Overview
 Microsoft Msx platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/microsoft_msx.json`
...
# Run in museum mode
showet-museum --platform microsoft_msx
```
