#  Atari 7800 Platform Documentation

## Overview
 Atari 7800 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/atari_7800.json`
...
| .a78 | Supported format | Native emulator |
| .bin | Supported format | Native emulator |
| .cdf | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform atari_7800
```
