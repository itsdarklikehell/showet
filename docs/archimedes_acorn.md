#  Archimedes Acorn Platform Documentation

## Overview
 Archimedes Acorn platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/archimedes_acorn.json`
...
| .7z | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform archimedes_acorn
```
