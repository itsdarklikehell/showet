#  Amstrad Cpcplus Platform Documentation

## Overview
 Amstrad Cpcplus platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/amstrad_cpcplus.json`
...
| .sna | Supported format | Native emulator |
| .kcr | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform amstrad_cpcplus
```
