#  Nintendo GameboyColor Platform Documentation

## Overview
 Nintendo GameboyColor platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nintendo_gameboycolor.json`
...
# Run in museum mode
showet-museum --platform nintendo_gameboycolor
```
