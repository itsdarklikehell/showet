#  Magnavox Odyssey Platform Documentation

## Overview
 Magnavox Odyssey platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/magnavox_odyssey.json`
...
# Run in museum mode
showet-museum --platform magnavox_odyssey
```
