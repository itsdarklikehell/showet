#  Sega GameGear Platform Documentation

## Overview
 Sega GameGear platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/sega_gamegear.json`
...
| .sms | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform sega_gamegear
```
