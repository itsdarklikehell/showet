#  Nec Pc8000 Platform Documentation

## Overview
 Nec Pc8000 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/nec_pc8000.json`
...
# Run in museum mode
showet-museum --platform nec_pc8000
```
