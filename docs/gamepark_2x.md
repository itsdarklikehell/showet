#  Gamepark 2X Platform Documentation

## Overview
 Gamepark 2X platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/gamepark_2x.json`
...
# Run in museum mode
showet-museum --platform gamepark_2x
```
