#  Snk NeogeoPocketColor Platform Documentation

## Overview
 Snk NeogeoPocketColor platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/snk_neogeopocketcolor.json`
...
# Run in museum mode
showet-museum --platform snk_neogeopocketcolor
```
