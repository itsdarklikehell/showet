# Fancon Pico8 Platform Documentation

## Overview
Fancon Pico8 platform for running retro demos with authentic presentation.
...
Located at: `nostalgist_configs/fancon_pico8.json`
...
| .p8 | Supported format | Native emulator |
| .png | Supported format | Native emulator |
...
# Run in museum mode
showet-museum --platform fancon_pico8
```
