...
class Platform_SpectraVision_SpectraVideo(PlatformBase):
    ...
    def initialize(self) -> bool:
        print("[SpectraVision SpectraVideo] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[SpectraVision SpectraVideo] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[SpectraVision SpectraVideo] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[SpectraVision SpectraVideo] State load: Delegated to RetroArch")
        return True
