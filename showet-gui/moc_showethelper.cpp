...
#define QT_MOC_LITERAL(idx, ofs, len)                            \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
                                                            qptrdiff(offsetof(qt_meta_stringdata_ShowetHelper_t, stringdata0) + ofs - idx * sizeof(QByteArrayData)))
...
void ShowetHelper : qt_static_metacall(QObject *_o, QMetaObject
                                       : Call _c, int _id, void **_a)
{
        ...
        : InvokeMetaMethod)
    {
        ...
        {
        case 0:
            _t->runError((*reinterpret_cast<QString(*)>(_a[1])));
            break;
        case 1:
            _t->runningChanged((*reinterpret_cast<bool(*)>(_a[1])));
            break;
        case 2:
            _t->supportedPlatformsChanged();
            break;
        case 3:
            _t->processFinished((*reinterpret_cast<int(*)>(_a[1])), (*reinterpret_cast < QProcess
                                                                     : ExitStatus(*) > (_a[2])));
            break;
        case 4:
            _t->processErrorOccurred((*reinterpret_cast < QProcess
                                      : ProcessError(*) > (_a[1])));
            break;
        case 5:
            _t->printRunError((*reinterpret_cast<QString(*)>(_a[1])));
            break;
        case 6:
            _t->runDemo((*reinterpret_cast<const uint(*)>(_a[1])));
            break;
        case 7:
            _t->cancelDemo();
            break;
             ...
             : IndexOfMethod)
    {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void(ShowetHelper
                            : *)(QString);
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ShowetHelper
                                                                  : runError))
            {
                *result = 0;
                return;
             ...
             : ReadProperty)
    {
        ...
        {
        case 0:
            *reinterpret_cast<bool *>(_v) = _t->m_running;
            break;
        case 1:
            *reinterpret_cast<QStringList *>(_v) = _t->m_supportedPlatforms;
            break;
        default:
            break;
        }
...
int ShowetHelper : qt_metacall(QMetaObject
                               : Call _c, int _id, void **_a)
{
             ...
             : RegisterMethodArgumentMetaType)
    {
        ...
        _id -= 9;
             ...
             : ReadProperty || _c == QMetaObject
             : WriteProperty || _c == QMetaObject
             : ResetProperty || _c == QMetaObject
...
{
    void *_a[] = {nullptr, const_cast<void *>(reinterpret_cast<const void *>(std
                                                                             : addressof(_t1)))};
QMetaObject:
    activate(this, &staticMetaObject, 0, _a);
}
...
void ShowetHelper : runningChanged(bool _t1)
{
    void *_a[] = {nullptr, const_cast<void *>(reinterpret_cast<const void *>(std
                                                                             : addressof(_t1)))};
QMetaObject:
    activate(this, &staticMetaObject, 1, _a);
}
...
{
QMetaObject:
    activate(this, &staticMetaObject, 2, nullptr);
}
QT_WARNING_POP
