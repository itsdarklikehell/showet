"""Runner for the pouet "commodorepet" platform.
...
class Platform_Commodore_Pet(PlatformCommon):
    """Platform runner for Commodorepet demos."""
    ...
    def supported_platforms(self) -> list[str]:
        """Return commodorepet platform slug."""
        return ["commodorepet"]
    ...
    def run(self) -> None:
        ...
        if DEBUGGING:
            print(f"Launching commodorepet demo via RetroArch: {files[0]}")
