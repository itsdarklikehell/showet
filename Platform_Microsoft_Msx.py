...
class Platform_Microsoft_Msx(PlatformBase):
    ...
    def supported_platforms(self) -> list[str]:
        ...
        return ["microsoft_msx"]

    def initialize(self) -> bool:
        print("[Microsoft Msx] Initializing...")
    ...
    def run_frame(self, controls: dict[str, Any]) -> bool:
        if not self.is_initialized() or not self._last_rom_path:
            return False
        if controls:
            print("[Microsoft Msx] Note: Control mapping pending")
        return True
    ...
    def save_state(self) -> bytes:
        print("[Microsoft Msx] State save: Delegated to RetroArch")
        return b""

    def load_state(self, state_data: bytes) -> bool:
        print("[Microsoft Msx] State load: Delegated to RetroArch")
        return True
